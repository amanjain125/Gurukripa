    ...
    <>
      ...
      <main className="bg-bone min-h-screen pt-28 md:pt-36 pb-24 relative overflow-hidden">
        ...
        <section className="container-wide relative z-10">
          ...
          {/* 3 Action Cards Grid with Brand Red Hover Border & Shadow */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10" data-reveal data-reveal-delay="260">
            {/* Card 1: Call */}
            <a
              href={`tel:${primaryPhoneClean}`}
              className="group bg-white/80 backdrop-blur-md rounded-3xl p-7 border border-white/90 hover:border-brand-red hover:shadow-[0_16px_32px_rgba(192,50,43,0.15)] hover:-translate-y-1 transition-all duration-300 block"
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <span className="text-[11px] font-bold tracking-widest text-brand-red uppercase block">CALL US</span>
                  <p className="font-bold text-ink text-[17px] tracking-tight">{primaryPhone}</p>
                </div>
              </div>
              <p className="text-[13.5px] text-ink/75 mb-5 leading-relaxed">
                Speak directly with a Gurukripa expert.
              </p>
              <span className="inline-flex items-center gap-1.5 text-[14px] font-bold text-brand-red group-hover:text-brand-red-deep">
                Call now <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
              </span>
            </a>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <span className="text-[11px] font-bold tracking-widest text-brand-red uppercase block">WHATSAPP</span>
                  <p className="font-bold text-ink text-[17px] tracking-tight">Chat with Gurukripa</p>
                </div>
              </div>
              <p className="text-[13.5px] text-ink/75 mb-5 leading-relaxed">
              ...
              <span className="inline-flex items-center gap-1.5 text-[14px] font-bold text-brand-red group-hover:text-brand-red-deep">
                Start chat <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
              </span>
            </a>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <span className="text-[11px] font-bold tracking-widest text-brand-red uppercase block">EMAIL</span>
                  <p className="font-bold text-ink text-[15px] truncate max-w-[200px]" title={COMPANY.email}>
                    {COMPANY.email}
                  </p>
                </div>
              </div>
              ...
              <span className="inline-flex items-center gap-1.5 text-[14px] font-bold text-brand-red group-hover:text-brand-red-deep">
                Send email <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
              </span>
            </a>
          </div>
        </section>
          ...
          <div className="glass-strong rounded-3xl p-6 sm:p-10 md:p-14 border border-white/80 shadow-xl" data-reveal>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
              ...
              <div className="lg:col-span-6 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-5">
                    <a
                      href={`tel:${primaryPhoneClean}`}
                      className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/90 border border-ink/15 text-[13px] font-semibold text-ink hover:border-brand-red hover:text-brand-red hover:shadow-sm transition-all"
                    >
              ...
              <div className="lg:col-span-6 lg:pl-4">
                <div className="bg-white/60 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-white/80 shadow-md">
        ...
        <section className="container-wide relative z-10 mt-16 md:mt-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-8" data-reveal>
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mt-6">
                  {[
                    ...
                    <div key={feature} className="glass rounded-2xl p-4 flex items-center gap-3 border border-white/70 hover:border-brand-red/40 transition-colors">
              ...
              {/* Map Container */}
              <div className="glass-strong rounded-3xl p-2.5 border border-white/80 shadow-md hover:border-brand-red/30 transition-colors">
