...
export const metadata: Metadata = {
  title: 'Construction Projects — Gurukripa Constructions',
  description:
    'Turnkey residential villas, commercial structures, RCC frames, and foundation engineering delivered across Bengaluru.',
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-4 flex flex-col gap-3 lg:items-end">
              <div className="bg-gold text-ink font-extrabold px-5 py-2.5 rounded-full text-xs shadow-xl border border-gold tracking-wide">
                {constructionProjects.length} Active & Delivered Projects
              </div>
              <Link
              ...
              >
                <span>Switch to Renovation Projects</span>
